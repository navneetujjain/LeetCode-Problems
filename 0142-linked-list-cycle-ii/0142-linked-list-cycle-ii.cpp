/* If you are looking at this solution then its not mine. I was revising and just liked   this solution. Beautiful explanation by "N7_BLACKCHAT" */ 
class Solution {
 public:
...
//Algorithm is called Hare-Tortoise Algorithm